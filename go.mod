module github.com/godeamon/chain-xevidence
...
require (
	...
	github.com/consensys/gnark v0.5.2 // indirect
	...
	github.com/xuperchain/crypto v0.0.0-20211221122406-302ac826ac90 // indirect
